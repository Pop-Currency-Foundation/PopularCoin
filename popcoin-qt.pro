...
DEFINES += MINIUPNP_STATICLIB QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE BOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN __NO_SYSTEM_INCLUDES
CONFIG += qt no_include_pwd
CONFIG += thread
CONFIG += static
QT += gui
...
## Windows Section -COMMENT THIS SECTION TO BUILD ON MAC
# Change paths if needed, these use the foocoin/deps.git repository locations
##
win32 {
BOOST_LIB_PREFIX=-mgw49-mt-s-1_54
...
## Mac Section -COMMENT THIS SECTION TO BUILD ON WINDOWS
##
macx {
BOOST_LIB_SUFFIX=-mt
...
MINIUPNPC_INCLUDE_PATH=/Users/VEMi/miniupnpc/include/miniupnpc
MINIUPNPC_LIB_PATH=/Users/VEMi/miniupnpc/lib
QMAKE_CXXFLAGS += -stdlib=libc++ -arch x86_64 -mmacosx-version-min=10.7
QMAKE_CFLAGS += -stdlib=libc++ -arch x86_64 -mmacosx-version-min=10.7
QMAKE_LFLAGS += -stdlib=libc++ -arch x86_64 -mmacosx-version-min=10.7
}
##
...
windows:LIBS += -lws2_32 -lshlwapi -lmswsock -lole32 -loleaut32 -luuid -lgdi32 -Wl,-Bstatic -lstdc++ -lpthread
